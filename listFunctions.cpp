...
//}
//
//void BookHero::sortToSeries() {
//    BookHero series{};
//    if (firstBook->Hero->status == "main") {
//        if (firstBook->releaseDate < firstBook->next->releaseDate) {
//            series.Add(firstBook);
//        } else {
//            series.Add(firstBook->next);
//        }
//    }
//
//}
